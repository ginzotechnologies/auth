...
public class RemoveScopesFromRoleUseCase implements RemoveScopesFromRolePort {
    ...
    @Override
    public Role remove(Long roleId, List<String> scopes)
    ...
    @Override
    public List<Role> removeFromAll(Long scopeId) throws DuplicatedKeyException {
        List<Role> rolesWithTheScope = findRolePort.findAllByScopeId(scopeId);
        return this.removeFromAll(rolesWithTheScope, List.of(scopeId.toString()));
    }
}
