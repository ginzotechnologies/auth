...
public interface RemoveScopesFromRolePort {
    ...
    Role remove(Long roleId, List<String> scopes) throws DuplicatedKeyException, NotFoundException;

    List<Role> removeFromAll(Long scopeId) throws DuplicatedKeyException;
