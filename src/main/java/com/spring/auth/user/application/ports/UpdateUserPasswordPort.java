...
public interface UpdateUserPasswordPort {
    ...
    void update(Long userId, String oldPassword, String newPassword)
            throws NotFoundException, DuplicatedKeyException, WrongPasswordException;

    void update(Long userId, String newPassword) throws NotFoundException, DuplicatedKeyException;
}
