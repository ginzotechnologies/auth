...
import com.spring.auth.user.application.ports.UpdateUserPasswordPort;
...
public class UpdateUserPasswordUseCase implements UpdateUserPasswordPort {
    ...
    private final PublishUpdatedPasswordEventPort publishUpdatedPasswordEventPort;
     ...
     */
    @Override
    public void update(Long userId, String oldPassword, String newPassword)
